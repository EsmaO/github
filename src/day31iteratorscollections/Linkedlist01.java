...
public class Linkedlist01 {
    public static void main(String[] args){
        ...
        //if our linkedlist is empty we need to handle it otherwise it will throw an exception"NoSuchElementException"

        System.out.println(ll1.getFirst());
        //this method created for Queue. it works same as element method
        //element method is created fot linkedlist
        //throws NoSuchElementException
        System.out.println(ll1.getLast());
        //return the last element

        System.out.println(ll1.peek());
        //peek method return thr first element
       ...
       // ll1.removeFirstOccurrence("Emir");
        //ll1.removeLastOccurrence("Emir");
